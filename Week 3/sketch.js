...
let reset = 0
let win_top_left_right_blue = 0
let win_middle_left_right_blue = 0
let win_bottom_left_right_blue = 0
let win_left_bottom_top_blue = 0
let win_middle_bottom_top_blue = 0
let win_right_bottom_top_blue = 0
let win_diagonal_left_right_blue = 0
let win_diagonal_right_left_blue = 0
let win_top_left_right_red = 0
let win_middle_left_rightred = 0
let win_bottom_left_right_red = 0
let win_left_bottom_top_red = 0
let win_middle_bottom_top_red = 0
let win_right_bottom_top_red = 0
